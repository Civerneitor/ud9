...
public class Vehiculo {
	...
	public void setConductor(Conductor conductor) throws Exception {
		if((conductor.getTipoLicencia()=='B' && this instanceof Coche) || (conductor.getTipoLicencia()=='A' && this instanceof Moto) || 
				(conductor.getTipoLicencia()=='C' && this instanceof Camion)) this.conductor.add(conductor);
